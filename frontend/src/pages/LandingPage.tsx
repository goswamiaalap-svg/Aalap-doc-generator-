...
export default function LandingPage() {
  return (
    <div className="min-h-screen bg-[#020617] text-white flex flex-col relative overflow-hidden selection:bg-blue-500/30">
      ...
      <div className="absolute top-[-10%] left-[-10%] w-[500px] h-[500px] bg-blue-600/10 blur-[120px] rounded-full animate-pulse pointer-events-none" />
      <div className="absolute bottom-[-10%] right-[-10%] w-[600px] h-[600px] bg-purple-600/10 blur-[140px] rounded-full animate-pulse delay-700 pointer-events-none" />
      ...
      <nav className="fixed top-0 inset-x-0 z-50 h-20 backdrop-blur-md bg-black/20 border-b border-white/5 px-8 flex items-center justify-between">
        <div className="flex items-center gap-3">
          <div className="p-2 bg-gradient-to-tr from-blue-600 to-indigo-600 rounded-xl shadow-[0_0_15px_rgba(37,99,235,0.4)]">
        ...
        <div className="hidden md:flex items-center gap-8 text-[11px] font-black uppercase tracking-widest text-gray-400">
          ...
          <Link to="/codegen" className="hover:text-purple-400 transition-colors">Neuro-Engine</Link>
      ...
      <main className="relative z-10 flex-1 flex flex-col items-center justify-center pt-32 pb-20 px-6 sm:px-12">
        <div className="max-w-5xl text-center space-y-8">
          ...
          <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-white/5 border border-white/10 text-[10px] font-black uppercase tracking-widest text-blue-400 animate-in fade-in slide-in-from-bottom-2 duration-700">
            <Zap size={14} className="fill-blue-400" />
            <span>Powered by Llama 3.3 Advanced Neural Stream</span>
          </div>

          <h1 className="text-6xl sm:text-8xl font-black tracking-tighter sm:leading-tight animate-in fade-in slide-in-from-bottom-4 duration-700 delay-100">
            The Future of <br/>
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-400 via-indigo-400 to-purple-500 drop-shadow-[0_0_10px_rgba(59,130,246,0.2)]">Documentation Intelligence</span>
          </h1>
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-6 pt-8 animate-in fade-in slide-in-from-bottom-8 duration-700 delay-300">
            <Link to="/docs" className="w-full sm:w-auto group relative px-10 py-5 bg-gradient-to-r from-blue-600 to-indigo-600 rounded-2xl text-sm font-black uppercase tracking-widest shadow-[0_20px_40px_rgba(37,99,235,0.25)] hover:scale-105 transition-all overflow-hidden">
        ...
        <div className="max-w-7xl w-full grid grid-cols-1 md:grid-cols-3 gap-8 mt-40">
          {[
            ...
            <div key={i} className="group relative p-8 bg-white/[0.03] border border-white/10 rounded-3xl overflow-hidden hover:border-white/20 hover:bg-white/[0.05] transition-all duration-500">
              ...
              <h3 className="text-xl font-black mb-4 tracking-tight uppercase group-hover:text-blue-400 transition-colors">{feature.title}</h3>
